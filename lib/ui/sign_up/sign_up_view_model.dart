...
class SignUpViewModel extends GetxController {
  ...
  void nicknameVaildate(String value) {
    ...
    if (value.isEmpty || value.length > 5) {
      ...
      isVaild.value = false;
    } else if (!validSpecialOrNumber(value) || !validKoreanOrEnglish(value)) {
  ...
  bool validSpecialOrNumber(String value) {
    final invalidSpecial = RegExp(r'[!@#\$%^&*(),.?":{}|<>]');
    final invalidNumber = RegExp(r'[0-9]');

    if (invalidSpecial.hasMatch(value) || invalidNumber.hasMatch(value)) {
      return false;
    }
    return true;
  }

  bool validKoreanOrEnglish(String value) {
    final validKorean =
